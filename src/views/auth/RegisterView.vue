                ...
                <div>
                    ...
                    <form @submit.prevent="register()"
                        ...
                        <input type="email"
                            ...
                            :aria-invalid="formErrors.email.length > 0 ? true : null">
                        ...
                        <input type="text"
                            ...
                            :aria-invalid="formErrors.username.length > 0 ? true : null">
                        ...
                        <input type="password"
                            ...
                            :aria-invalid="formErrors.password.length > 0 ? true : null">
